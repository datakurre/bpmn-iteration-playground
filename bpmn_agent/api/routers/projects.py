...
mechanical wiring of what `bpmn_agent/projects.py` already provides.
"""
...
from bpmn_agent.models import CreateProjectRequest, ProjectDetail, ProjectSummary, SpawnTaskRequest
from bpmn_agent.projects import DuplicateProjectError, ProjectNotFoundError, ProjectService


def build_router(get_project_service: Callable[[], ProjectService]) -> APIRouter:
    router = APIRouter()
