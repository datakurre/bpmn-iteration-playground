...
from bpmn_agent.orchestration import fork as fork_module
from bpmn_agent.orchestration.jobs import (
...
class WorkflowService:
    ...
    The implementation is split by concern across `bpmn_agent/orchestration/`:
    ...
    async def shutdown(self) -> None:
        ...
        on borrowed time. Bounded workspace I/O (see bpmn_agent.workspace) means a
